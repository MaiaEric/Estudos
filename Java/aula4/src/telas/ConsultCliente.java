...
void cosultar(){
    try{
       ...
       JOptionPane.showMessageDialog
        (null,"CPF não foi encontrado");
                        jcpf.setText("");
                        jcpf.requestFocus();
        }else{
            jcodigo.setText(String.valueOf(cliente.getIdCliente()));
            jcpf2.setText(cliente.getCpfCliente());
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Digite o CPF"));
        ...
        jcodigo.setForeground(new java.awt.Color(0, 102, 255));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addComponent(jcpf, javax.swing.GroupLayout.PREFERRED_SIZE, 236, javax.swing.GroupLayout.PREFERRED_SIZE)
